...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.ok) {
      ...
      router.push("/dashboard"); // Redirect directly to dashboard or onboarding
    } else {
      const data = await res.json();
      setError(data.error || "Registracija ni uspela");
      toast.error(data.error || "Registracija ni uspela");
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="mt-2 flex gap-4">
              ...
              <label className="flex items-center gap-2 cursor-pointer hover:bg-blue-50 p-2 rounded transition">
